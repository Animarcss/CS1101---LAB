...
int main()
{
	...
	while(1)
	{
		int x1 = 150+sin(t*0.02)*40;
		int y1 = 100+cos(t*0.02)*40;
		
		draw_circle(x1,y1,10,	0xFFFF);
		
		int x2 = 150+sin(t*0.03+20)*64;
		int y2 = 100+cos(t*0.03+20)*64;
		
		draw_circle(x2,y2,12,0xF800);
		
		
		int x3 = 150+sin(t*0.05+20)*90;
		int y3 = 100+cos(t*0.05+20)*90;
		
		draw_circle(x3,y3,8,0x001F);
		
				
		int x4 = 150+sin(-t*0.5+20)*25;
		int y4 = 100+cos(-t*0.5+20)*25;
		
		draw_circle(x4,y4,4,0x06F0);
		
		draw_circle(x1,y1,10,	0x0000);
		draw_circle(x2,y2,12,0x0000);
		draw_circle(x3,y3,8,0x0000);
		draw_circle(x4,y4,4,0x0000);
